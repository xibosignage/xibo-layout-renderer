...
function _getDataBlob() {
  _getDataBlob = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(src) {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          return _context7.abrupt("return", fetch(src, {
            mode: 'no-cors'
          }).then(function (res) {
            return res.blob();
          }).then(function (blob) {
...
function _preloadMediaBlob() {
  _preloadMediaBlob = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(src, type) {
    var res, blob, data;
...
function _fetchJSON() {
  _fetchJSON = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(url) {
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          return _context9.abrupt("return", fetch(url).then(function (res) {
            return res.json();
          })["catch"](function (err) {
            console.log(err);
          }));
...
function getIndexByLayoutId(layoutsInput, layoutId) {
  var layoutIndexes = layoutsInput.reduce(function (a, b, indx) {
    a[Number(b.layoutId)] = _objectSpread(_objectSpread({}, b), {}, {
      index: indx
    });
    return a;
  }, {});
...
var flyInElem = function flyInElem(duration, keyframeOptions, direction) {
  ...
  if (keyframeOptions && Boolean(keyframeOptions.from)) {
    flyInKeyframes[0] = _objectSpread(_objectSpread({}, keyframeOptions.from), flyInKeyframes[0]);
  }
  if (keyframeOptions && Boolean(keyframeOptions.to)) {
    flyInKeyframes[1] = _objectSpread(_objectSpread({}, keyframeOptions.to), flyInKeyframes[1]);
  }
  return {
...
var flyOutElem = function flyOutElem(duration, keyframeOptions, direction) {
  ...
  if (keyframeOptions && Boolean(keyframeOptions.from)) {
    flyOutKeyframes[0] = _objectSpread(_objectSpread({}, keyframeOptions.from), flyOutKeyframes[0]);
  }
  if (keyframeOptions && Boolean(keyframeOptions.to)) {
    flyOutKeyframes[1] = _objectSpread(_objectSpread({}, keyframeOptions.to), flyOutKeyframes[1]);
  }
  return {
...
function Media(region, mediaId, xml, options, xlr) {
  ...
  var mediaObject = _objectSpread(_objectSpread({}, initialMedia), props);
  var startMediaTimer = function startMediaTimer(media) {
    mediaTimer = setInterval(function () {
      mediaTimeCount++;
      if (mediaTimeCount > media.duration) {
        var _media$emitter3;
        (_media$emitter3 = media.emitter) === null || _media$emitter3 === void 0 || _media$emitter3.emit('end', media);
      }
    }, 1000);
  ...
  mediaObject.init = function () {
    ...
    self.options = _objectSpread(_objectSpread({}, props.options), {}, {
      mediaId: mediaId
    });
    ...
    var resourceUrlParams = _objectSpread(_objectSpread({}, xlr.config.config), {}, {
...
function Region(layout, xml, regionId, options, xlr) {
  ...
  var emitter = createNanoEvents();
  var regionObject = _objectSpread(_objectSpread({}, initialRegion), props);
  regionObject.prepareRegion = function () {
    var _self$xml6, _self$xml7, _self$xml8, _self$xml9, _self$xml10, _self$xml11;
    var self = regionObject;
    var layout = self.layout,
      options = self.options;
    self.id = props.regionId;
    self.options = _objectSpread(_objectSpread({}, platform), props.options);
    self.containerName = "R-".concat(self.id, "-").concat(nextId(self.options));
    self.xml = props.xml;
    self.mediaObjects = [];
    self.sWidth = self.xml && Number((_self$xml6 = self.xml) === null || _self$xml6 === void 0 ? void 0 : _self$xml6.getAttribute('width')) * layout.scaleFactor;
    self.sHeight = self.xml && Number((_self$xml7 = self.xml) === null || _self$xml7 === void 0 ? void 0 : _self$xml7.getAttribute('height')) * layout.scaleFactor;
    self.offsetX = self.xml && Number((_self$xml8 = self.xml) === null || _self$xml8 === void 0 ? void 0 : _self$xml8.getAttribute('left')) * layout.scaleFactor;
    self.offsetY = self.xml && Number((_self$xml9 = self.xml) === null || _self$xml9 === void 0 ? void 0 : _self$xml9.getAttribute('top')) * layout.scaleFactor;
    self.zIndex = self.xml && Number((_self$xml10 = self.xml) === null || _self$xml10 === void 0 ? void 0 : _self$xml10.getAttribute('zindex'));
    var regionOptions = (_self$xml11 = self.xml) === null || _self$xml11 === void 0 ? void 0 : _self$xml11.getElementsByTagName('options');
    if (regionOptions) {
      for (var _i3 = 0, _Array$from3 = Array.from(regionOptions); _i3 < _Array$from3.length; _i3++) {
        var _options = _Array$from3[_i3];
        // Get options
        var _regionOptions = _options.children;
        for (var _i4 = 0, _Array$from4 = Array.from(_regionOptions); _i4 < _Array$from4.length; _i4++) {
          var regionOption = _Array$from4[_i4];
...
function _getXlf() {
  _getXlf = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(layoutOptions) {
    var apiHost, xlfUrl, res;
...
function getLayout(params) {
  ...
  if (currentLayout === undefined && nextLayout === undefined) {
    ...
    if (hasLayout) {
      var nextLayoutTemp = _objectSpread({}, initialLayout);
      activeLayout = inputLayouts[currentLayoutIndex];
      _currentLayout = _objectSpread(_objectSpread({}, initialLayout), activeLayout);
      if (inputLayouts.length > 1) {
        nextLayoutTemp = _objectSpread(_objectSpread({}, nextLayoutTemp), inputLayouts[nextLayoutIndex]);
    ...
    if (hasLayout) {
      ...
      if (inputLayouts.length > 1 && nextLayoutIndex < inputLayouts.length) {
        if (Boolean(params.xlr.layouts[nextLayoutIndex])) {
          ...
          _nextLayout = _objectSpread(_objectSpread({}, initialLayout), inputLayouts[nextLayoutIndex]);
        }
      }
...
function Layout(data, options, xlr, layout) {
  ...
  var layoutObject = _objectSpread(_objectSpread({}, props.layout), {}, {
  ...
  layoutObject.parseXlf = function () {
    ...
    if (!(layout.bgImage === "" || typeof layout.bgImage === 'undefined')) {
      ...
      var bgImageUrl = composeBgUrlByPlatform(xlr.config.platform, _objectSpread(_objectSpread({}, options), {}, {
        layout: layout
      }));
      if ($layout) {
  ...
  layoutObject.regionEnded = function () {
    ...
    if (self.allEnded) {
      self.stopAllMedia().then(function () {
        ...
        (_self$emitter2 = self.emitter) === null || _self$emitter2 === void 0 || _self$emitter2.emit('end', self);
      });
    }
  };
...
function XiboLayoutRenderer(inputLayouts, options) {
  ...
  var xlrObject = _objectSpread(_objectSpread({}, initialXlr), {}, {
    bootstrap: function bootstrap() {
      ...
      self.config = JSON.parse(JSON.stringify(_objectSpread(_objectSpread({}, platform), props.options)));
    },
    init: function init() {
      var _this2 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              newOptions = _objectSpread(_objectSpread({}, newOptions), props.options);
