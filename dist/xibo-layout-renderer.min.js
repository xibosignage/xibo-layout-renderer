...
var XiboLayoutRenderer = function () {
  ...
  var e = function e() {
    return {
      emit: function emit(e) {
        ...
        for (var _o = 0, _n = this.events[e] || [], _i = _n.length; _o < _i; _o++) _n[_o].apply(_n, t);
      },
      events: {},
      on: function on(e, t) {
        var _this$events,
          _this = this;
        return ((_this$events = this.events)[e] || (_this$events[e] = [])).push(t), function () {
          var _this$events$e;
          _this.events[e] = (_this$events$e = _this.events[e]) === null || _this$events$e === void 0 ? void 0 : _this$events$e.filter(function (e) {
            return t !== e;
          });
        };
      }
  ...
  function h(t, o, l, d, s) {
    ...
    return y.on("start", function (e) {
      ...
      if (a) for (var _i2 = 0, _Array$from = Array.from(a); _i2 < _Array$from.length; _i2++) {
        var _t = _Array$from[_i2];
        var _o2 = _t.children;
        for (var _i3 = 0, _Array$from2 = Array.from(_o2); _i3 < _Array$from2.length; _i3++) {
          var _t2 = _Array$from2[_i3];
      ...
      if (e.url = u, e.loop = "1" == e.options.loop || "1" == e.region.options.loop && 1 == e.region.totalMediaObjects, t.src = "".concat(u, "&width=").concat(e.divWidth, "&height=").concat(e.divHeight), "html" === e.render || "ticker" === e.mediaType || "webpage" === e.mediaType) e.checkIframeStatus = !0, e.iframe = t;else if ("image" === e.mediaType) {
        if ("stretch" === e.options.scaletype) l.style.cssText = l.style.cssText.concat("background-size: 100% 100%;");else if ("fit" === e.options.scaletype) l.style.cssText = l.style.cssText.concat("background-size: cover;");else {
          var _t3 = "" == e.options.align ? "center" : e.options.align,
            _o3 = "" == e.options.valign || "middle" == e.options.valign ? "center" : e.options.valign;
          l.style.cssText = l.style.cssText.concat("background-position: ".concat(_t3, " ").concat(_o3));
        }
      ...
      if (Boolean(e.options.transin) && Boolean(e.options.transinduration)) {
        ...
        l.animate(_o4.keyframes, _o4.timing);
      }
      e.html = l;
    }, h.run = function () {
      var e = h;
      ...
      if (Boolean(e.options.transin)) {
        ...
        "fly" === _t8 && (_t8 = "".concat(_t8, "In"), n.keyframes = f({
          trans: "in",
          direction: o,
          height: e.divHeight,
          width: e.divWidth
      ...
      Array.from(m).forEach(function (a, d) {
        var u = function (o, a, r, l, d) {
          ...
          return p.prepareRegion = function () {
            ...
            if (a) for (var _i4 = 0, _Array$from3 = Array.from(a); _i4 < _Array$from3.length; _i4++) {
              var _t12 = _Array$from3[_i4];
              var _o5 = _t12.children;
              for (var _i5 = 0, _Array$from4 = Array.from(_o5); _i5 < _Array$from4.length; _i5++) {
                var _t13 = _Array$from4[_i5];
            ...
            if (e.mediaObjects.length > 0) {
              ...
              var _o6 = document.getElementById("".concat(e.containerName));
              e.curMedia && _o6 && _o6.insertBefore(e.curMedia.html, _o6.lastElementChild), e.nxtMedia && _o6 && _o6.insertBefore(e.nxtMedia.html, _o6.lastElementChild);
            }
          }, p.run = function () {
            ...
            if (t) {
              ...
              e && Boolean(e.options.transout) && (_r2 = e.options.transout, "fly" === _r2 && (_r2 = "".concat(_r2, "Out"), _l.keyframes = f({
                trans: "out",
                direction: a,
                height: e.divHeight,
                width: e.divWidth
              ...
              var _s = new Promise(function (t) {
                if (e) {
                  ...
                  if (_a2) {
                    ...
                    }) : (setTimeout(_i6, n / 2), t(!0)) : (_i6(), t(!0));
                  }
                }
              });
      ...
      a = _objectSpread(_objectSpread({}, w), {}, {
        ...
        init: function init() {
          ...
          return new Promise(function (e) {
            ...
            }(document.querySelector(".preview-canvas")), _this2.prepareLayouts().then(function (t) {
              e(t);
            });
          });
        },
