...
function SplashScreen($parent) {
  ...
  var splashScreenObj = {
    init: function init() {
      ...
      $previewSplash.style.setProperty('background-image', "url(".concat(new URL((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__dirname + '/assets/xibologo-DuTyDLWy.png').href : new URL('assets/xibologo-DuTyDLWy.png', document.currentScript && document.currentScript.src || document.baseURI).href), (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('xibo-layout-renderer.cjs.js', document.baseURI).href))).href, ")"));
      $previewLoader.classList.add('preview-loader');
      $previewLoader.style.setProperty('background-image', "url(".concat(new URL((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__dirname + '/assets/loader-BOF1C3SB.gif').href : new URL('assets/loader-BOF1C3SB.gif', document.currentScript && document.currentScript.src || document.baseURI).href), (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('xibo-layout-renderer.cjs.js', document.baseURI).href))).href, ")"));
